...
const LABEL_MAP = {
    ...
    moon: LabTatasuryaStrings.moonMassStringProperty
};
...
class MassControlPanel extends VBox {
    ...
    public constructor( massSettableBodies: Body[], providedOptions?: MassControlPanelOptions ) {
        ...
        const defaults: OptionizeDefaults<EmptySelfOptions, VBoxOptions> = merge( LabTatasuryaConstants.CONTROL_PANEL_OPTIONS, {
...
labTatasurya.register( 'MassControlPanel', MassControlPanel );
