...
import LabTatasuryaControls from './LabTatasuryaControls.js';
import LabTatasuryaConstants from '../LabTatasuryaConstants.js';
import MassControlPanel from './MassControlPanel.js';
import LabTatasuryaTimeControlNode from './LabTatasuryaTimeControlNode.js';
...
*/
public constructor( model: LabTatasuryaModel, tandem: Tandem ) {
    ...
    const controlPanel = new LabTatasuryaControls( model, this, {
    ...
    const playAreaNodeTandem = tandem.createTandem( LabTatasuryaConstants.PLAY_AREA_TANDEM_NAME );
    ...
    this.addChild( new VBox( {
        ...
        stretch: true,
        children: [
            new Panel( controlPanel, combineOptions<PanelOptions>( {}, LabTatasuryaConstants.CONTROL_PANEL_OPTIONS, {
    ...
    const timeControlNode = new LabTatasuryaTimeControlNode( model, {
