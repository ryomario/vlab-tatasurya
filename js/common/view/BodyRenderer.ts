...
export default abstract class BodyRenderer extends Node {
    ...
    private static readonly ImageRenderer: typeof BodyRenderer;
    private static readonly SwithableBodyRenderer: typeof SwitchableBodyRenderer;
...
labTatasurya.register( 'BodyRenderer', BodyRenderer );
...
export class ImageRenderer extends BodyRenderer {
    ...
    public constructor( body: Body, viewDiameter: number, imageName: HTMLImageElement ) {
        super( body );
...
labTatasurya.register( 'ImageRenderer', ImageRenderer );
...
labTatasurya.register( 'SunRenderer', SunRenderer );