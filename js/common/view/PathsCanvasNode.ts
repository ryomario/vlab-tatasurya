...
class PathsCanvasNode extends CanvasNode {
    ...
    public constructor( bodies: Body[], transformProperty: Property<ModelViewTransform2>, visibleProperty: BooleanProperty, canvasBounds: Bounds2 ) {
...
labTatasurya.register( 'PathCanvasNode', PathsCanvasNode );
...
labTatasurya.register( 'NamedPoints', NamedPoints );
