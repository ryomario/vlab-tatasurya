...
class LabTatasuryaModel {
    ...
    constructor( createModes: ( arg0: LabTatasuryaModel ) => SceneFactory, initialSceneIndex: number, tandem: Tandem ) {
        const showMassCheckbox = false;
        const showMeasuringTape = false;
