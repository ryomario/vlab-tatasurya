...
import BodyRenderer, { SwitchableBodyRenderer } from "../view/BodyRenderer.js";
...
import LabTatasuryaModel from "./LabTatasuryaModel.js";
...
class Body extends PhetioObject {
    ...
    public readonly freezeRewindChangeProperty: BooleanProperty;
    ...
    public static readonly BodyIO = new IOType<Body, BodyStateType>( 'BodyIO', {
        ...
        stateSchema: {
            pathLength: NumberIO,
            modePathLength: NumberIO,
            path: ArrayIO( Vector2.Vector2IO )
        }
    } );

    public constructor( type: BodyTypeEnum, bodyConfiguration: BodyConfiguration, color: Color, highlight: Color, renderer: ( arg0: Body, arg1: number ) => BodyRenderer, labelAngle: number, tickValue: number, tickLabelProperty: TReadOnlyProperty<string>, model: LabTatasuryaModel, tandem: Tandem, providedOptions?: BodyOptions ) {
        ...
        // indicates how much the radius should be expanded in any views
        this.touchDilation = options.touchDilation;

        // Keep track of the time at the beginning of a time step, for interpolation
        this.previousPosition = new Vector2( 0, 0 );

        const diamter =  ( bodyConfiguration.radius * 2 ) * options.diameterScale;
        ...
        this.diameterProperty = new NumberProperty( diamter, {
        ...
        this.freezeRewindChangeProperty = new BooleanProperty( false );
        ...
        this.forceProperty = new RewindableProperty( changeRewindValueProperty, new Vector2( 0, 0 ), {
            phetioDocumentation: 'The net force gravity exerted on this body by other bodies',
            phetioValueType: Vector2.Vector2IO,
        ...
        this.forceMagnitudeProperty = new DerivedProperty( [ this.forceProperty ], force => force.magnitude, {
            phetioDocumentation: 'The magnitude of the ner force on this body by other bodies',
            phetioValueType: NumberIO,
...
labTatasurya.register( 'Body', Body );
export default Body;
